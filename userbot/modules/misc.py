...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/karandon24/userbot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/karandon24/userbot) to open OpenUserBot's GitHub page."
    )
